...
if (!dir.exists(file.path(saveDir, "immuneEndo"))) {
    RunCellChat(immuneEndo, "immuneEndo", age, projectDir = projectDir)
...
if (!dir.exists(file.path(saveDir, "immuneEndoFemale"))) {
    ...
    RunCellChat(immuneEndoFemale, "immuneEndoFemale", age, projectDir = projectDir)
...
if (!dir.exists(file.path(saveDir, "immuneEndoMale"))) {
    immuneEndoMale <- subset(immuneEndo, subset = sex == "Male")
    RunCellChat(immuneEndoMale, "immuneEndoMale", age, projectDir = projectDir)
