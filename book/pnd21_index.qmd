...
# PND 21 Preprocessing and Integration
...
-   Sample 1 : Room Air F PND21 - FASTQ 24090.  
-   Sample 2 : Room Air M PND21 - FASTQ 24091. 
...
if (!file.exists(integratedDir)) {
    ...
    rm(publicationObjects)
    gc()
    integratedRA <- subset(integrated, subset = experiment == "Room_Air")
    save(integrated, file = integratedDir)
    save(integratedRA, file = file.path(projectDir, "data", age, "integratedRA.RData"))
}
```
